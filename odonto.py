...
img1_b64 = img_to_base64("./fotos/Design sem nome (12).png") or img_to_base64("./fotos/Design sem nome (12).png")
...
if img1_b64:
    logos_html += f'<img src="data:image/png;base64,{img1_b64}" style="height: 100px; width: auto;" />'
logos_html += '</div>'
    ...
    if st.button("📄 Gerar Documento Word (.docx)", type="primary"):
        if not prof_nome.strip() or not pac_nome.strip() or not caso_duvida.strip() or not prof_cpf.strip() or not pac_cpf.strip():
            ...
            try:
                ...
                logos_para_word = ["./fotos/logo3.png", "./fotos/Design sem nome (12).png"]
